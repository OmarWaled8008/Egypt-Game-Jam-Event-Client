      ...
      <header className="sticky top-0 z-50 w-full border-b border-white/10 bg-background-light/80 dark:bg-background-dark/80 backdrop-blur-md">
        <div className="max-w-[1440px] mx-auto px-6 h-16 flex items-center justify-between">
          <div className="flex items-center gap-8">
            ...
            <nav className="flex justify-center md:hidden w-[80%] items-center gap-6 absolute right-[50%] translate-x-[50%] top-16 bg-background-light/90 dark:bg-background-dark/90 backdrop-blur-md rounded-lg px-4 py-2">
              <NavLink
                className={({ isActive }) =>
                  isActive
                    ? "text-sm font-medium text-primary border-b-2 border-primary pb-1"
